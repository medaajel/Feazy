...
var grammar = {
    ...
    {"name": "value", "symbols": ["value_with_unity"]},
    ...
    {"name": "statement", "symbols": ["statement$string$1", "_", {"literal":"{"}, "_", "statement$ebnf$3", "_", {"literal":"}"}, "_", {"literal":";"}], "postprocess": 
        d => {
                return {
                    type:"head",
                    sub_tags: d[4],
    ...
    {"name": "statement", "symbols": [{"literal":"$"}, "tagname", "_", {"literal":"{"}, "_", "statement$ebnf$4", "_", {"literal":"}"}, "_", {"literal":";"}], "postprocess": 
        d => {
                return {
                    type:"head_tag",
                    tagname: d[1],
    ...
    {"name": "value_with_unity$subexpression$1", "symbols": ["value_with_unity$subexpression$1$string$3"]},
    {"name": "value_with_unity$subexpression$1", "symbols": [{"literal":"%"}]},
    {"name": "value_with_unity", "symbols": ["value_with_unity$ebnf$1", "_", "value_with_unity$subexpression$1"], "postprocess": d => d[0].join("") + d[2]},
    {"name": "value_with_unity", "symbols": ["string"], "postprocess": id},
    {"name": "value_with_unity$subexpression$2$string$1", "symbols": [{"literal":"p"}, {"literal":"x"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "value_with_unity$subexpression$2", "symbols": ["value_with_unity$subexpression$2$string$1"]},
    {"name": "value_with_unity$subexpression$2$string$2", "symbols": [{"literal":"r"}, {"literal":"e"}, {"literal":"m"}], "postprocess": function joiner(d) {return d.join('');}},
    ...
    {"name": "value_with_unity", "symbols": [/[#]/, /[0-9A-Fa-f]/, /[0-9A-Fa-f]/, /[0-9A-Fa-f]/, /[0-9A-Fa-f]/, /[0-9A-Fa-f]/, /[0-9A-Fa-f]/], "postprocess": d => d[0] + d[1] + d[2] + d[3] + d[4] + d[5] + d[6]},
    ...
    {"name": "value_with_unity", "symbols": ["value_with_unity$ebnf$2"], "postprocess": d => d[0].join("")},
